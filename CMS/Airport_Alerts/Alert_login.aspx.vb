...
Partial Class CMS_Airport_Alerts_Alert_login
    ...
    Protected Sub btnSumbit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSumbit.Click
        Try
            ...
            If (Users.Login_Verify(txtUserName.Text, DefaultValues.Admin) = True) Then
                If Me.AutenticateUser(domain, txtUserName.Text, txtPassword.Text) = True Then
                    Response.Redirect("AddAlert.aspx")
                End If
            Else
                lblMessage.Text = "User does not exist in the '" & DefaultValues.Admin & "' Group. Please Contact Administrator"
            End If
