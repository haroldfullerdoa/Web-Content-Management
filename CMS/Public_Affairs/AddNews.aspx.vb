...
Partial Class CMS_Public_Affairs_AddNews
    ...
    Protected Sub btnSumbit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSumbit.Click
        Try
            ...
            Dim newuser As New Users(0, txtPressTitle.Text, txtDate.Text, txtArticle.Text, task, DefaultValues.Press_News, "Press_News")
