<%@ Page  ValidateRequest="false" Language="VB" MasterPageFile="~/CMS/MasterScreens/SiteMaster.master" AutoEventWireup="false" CodeFile="AddPressRelease.aspx.vb" Inherits="Summer_Intern_Admin" title="Content Management System – Public Affairs - Add Press Release" %>
...
<table width="425" border="0" align="center" cellpadding="2" cellspacing="4">
  ...
  <tr>
   ...
   <tr>
    <td colspan="2" align="center">
    <p>*Click <a href="NewsRoom-Template.txt">here</a> for an easy-to-use template.</p>
    </td>
    </tr>
  ...
  <tr>
    <td colspan="2" align="center">
     <asp:Button ID="btnSumbit"  CssClass="button" runat="server" Text="Publish this Press Release"/>
     &nbsp;
