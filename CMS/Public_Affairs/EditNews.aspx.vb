...
Partial Class CMS_Public_Affairs_EditNews
    ...
    Protected Sub FormView1_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewCommandEventArgs) Handles FormView1.ItemCommand
        ...
        Try
            ...
            newuser = New Users(dplPressTitle.SelectedValue, txtPressTitle.Text, txtDate.Text, txtArticle.Text, task, DefaultValues.Press_News, "Press_News")
        ...
        Finally
            If task = "Update" Then
                lblMessage.Text = "News Story is updated"

            Else
                lblMessage.Text = "News Story is Deleted"
