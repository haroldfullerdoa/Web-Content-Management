<%@ Page Language="VB" ValidateRequest="false"  MasterPageFile="~/CMS/MasterScreens/SiteMaster.master" AutoEventWireup="false" CodeFile="EditPress_Release.aspx.vb" Inherits="CMS_Admin_EditUSer" title="Content Management System – Public Affairs - Add Press Release" %>
...
<table width="500" border="0" align="center" cellpadding="2" cellspacing="4">
 ...
 <tr>
  ...
  <tr>
  <td colspan="2"   class="LoginHeadings" align="center">
   <label> Select Press Release Title:</label>
  </td>
 </tr>
 
     <tr>
      <td colspan="2"><asp:DropDownList ID="dplPressTitle" runat="server" DataSourceID="SqlDataSource1" DataTextField="PRESS_REL_TITLE" DataValueField="PRESS_REL_ID" AutoPostBack="true" AppendDataBoundItems="true">
     <asp:ListItem  Text="Select Press Title--" Value="0"></asp:ListItem>
        ...
        ProviderName="<%$ ConnectionStrings:DOAINT.ProviderName %>" SelectCommand='SELECT "PRESS_REL_ID", "PRESS_REL_TITLE" FROM "CMS_PRESS_REL" ORDER BY "PRESS_REL_TITLE"'>
    </asp:SqlDataSource>
...
<hr size="1" width="100%" />
  ...
  <tr>
    ...
    <td width="60%"><asp:TextBox ID="txtArticle" runat="server"   TextMode="multiLine" Width="300px" Height="175px" MaxLength="1000" Text='<%#DataBinder.Eval(Container.DataItem,"Admin_Unit")%>'></asp:TextBox>
...
<EditItemTemplate>
  ...
  <tr>
    <td align="right" class="LoginHeadings" width="40%"><label> Detailed Article:</label></td>
    <td width="60%"><asp:TextBox ID="txtArticle" runat="server"   TextMode="multiLine" Width="200px"  Height="175px" MaxLength="1000" Text='<%#DataBinder.Eval(Container.DataItem,"Admin_Unit")%>'></asp:TextBox>
    <asp:RequiredFieldValidator ID="ReArticle" runat="server" ErrorMessage="Detailed Article"
                    ControlToValidate="txtArticle">*</asp:RequiredFieldValidator>
    </td>
  </tr>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetUserById" UpdateMethod="Savenewuser" DeleteMethod="Savenewuser"
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="dplPressTitle" Name="userId" PropertyName="SelectedValue"
                    Type="Int32" />
                <asp:Parameter DefaultValue="Press" Name="module_type" Type="String" />
            </SelectParameters>
